...
('site_title','BangTanSonyeondan Archive',NOW(),NOW()),
('site_subtitle','A purple, polished, fan-made universe for BTS members, music, memories, quotes, timelines, and ARMY energy.',NOW(),NOW()),
('hero_kicker','⟭⟬ BTS FOREVER · ARMY HOMEBASE ⟬⟭',NOW(),NOW()),
('hero_title','Your cinematic BTS archive — fun, organized, purple, and actually useful.',NOW(),NOW()),
('hero_body','Explore member vaults, eras, songs, quotes, gallery moments, votes, and timeline highlights in one clean fan archive built for real ARMY browsing.',NOW(),NOW()),
('footer_text','BangTanSonyeondan Archive is a fan-made BTS universe created with love. Please support official BTS channels whenever possible.',NOW(),NOW()),
('admin_email','hello@bangtansonyeondan.com',NOW(),NOW()),
('location','Purple Universe',NOW(),NOW()),
